...
def main(COMPLETIONS_PATH, OUTPUT_PATH):
    ...
    def get_safety_label(row):
        chat = [
            ...
            {"role": "user", "content": row["jailbreak_prompt"]},
...
if __name__ == "__main__":
    ...
    for model in models:
        INPUT_PATH = f"./completions/ab-completions-{model}.csv"
        OUTPUT_PATH = f"./evaluations/ab-completions-{model}-llamaguard-eval.csv"
